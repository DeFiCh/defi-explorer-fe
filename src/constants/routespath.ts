...
import { CHAIN, NETWORK } from './configs';
...
export const DEFAULT_BASE_PATH = `/${CHAIN}/${NETWORK}`;
...
export const ADDRESS_TOKEN_LIST_PAGE_URL_NAME = `${TOKEN_LIST_PAGE_URL_NAME}/${ADDRESS_URL_NAME}`;
...
export const CHAIN_NETWORK_PATH = `/${CHAIN}/:network`;
...
export const ADDRESS_TOKEN_LIST_PAGE = `${TOKEN_BASE_PATH}/${ADDRESS_URL_NAME}/:owner`;
